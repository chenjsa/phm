...
<body>
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		<div id="loginbox">
			<form action="" method="post" name="loginForm"
				...
				<div style="float:right;padding-right:30%;">
				    <div style="float: left;">
                        <input name="form-field-checkbox" id="sysUserChk" type="checkbox"
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright ©st 2016</span></font>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var data2={"no":loginname,"password":password,"code":code,"userType":sysUser};  
				$.ajax({
					type: "POST",
					url: 'login_login',
