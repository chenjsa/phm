...
public class Page {
	...
	@ApiModelProperty(value="取得当前页数",name="page",example="1")
	private String page="1";//取得当前页数,注意这是jqgrid自身的参数
    @ApiModelProperty(value="每页显示行数",name="rows",example="10")
	private String rows="10";//取得每页显示行数，,注意这是jqgrid自身的参数
	...
	public int getCurrentPage() {
		if(currentPage<=0)
			currentPage = 1;
		//System.out.println("currentPage====x:"+currentPage);
		//System.out.println("getTotalPage====x:"+getTotalPage());
