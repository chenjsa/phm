...
public class DefaultProcessDiagramCanvas {
  ...
  protected static Color HIGHLIGHT_COLOR_RED1 = Color.RED;
  ...
  // Fonts
  protected static Font LABEL_FONT = new Font("微软雅黑", Font.LAYOUT_RIGHT_TO_LEFT, 15);
  ...
  public void initialize(String imageType) {
    ...
    LABEL_FONT = new Font("", Font.BOLD, 13);
  ...
  public void drawHighLightRed1(int x, int y, int width, int height) {
	    Paint originalPaint = g.getPaint();
	    Stroke originalStroke = g.getStroke();
  ...
  public void drawHighLightRed(int x, int y, int width, int height) {
		...
		g.setPaint(HIGHLIGHT_COLOR_RED1);
		g.setStroke(THICK_TASK_BORDER_STROKE);
