								...
								<c:when test="${not empty varList}"> 
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'><a href="javascript:goSondict('${var.id}')"><i class="ace-icon fa fa-share bigger-100"></i>&nbsp;${var.deptName}</a></td>
											<td class='center'><a href="javascript:goSondict('${var.id}')">${var.casCode}</a></td>
							...
							<tr>
								<td style="vertical-align:top;"> 
								   <c:if test="${DEPARTMENT_ID!='0'}">
									...
									<a class="btn btn-sm btn-success" onclick="goSondict('${PARENT_ID}');">返回</a>
									</c:if>
								</td>
